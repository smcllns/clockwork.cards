  ...
  return (
    <Slide id="4b">
      ...
      <Body>
        <ul>
          <li>
          Assuming: <InlineStepper value={strokesPerMin} min={100} max={300} step={10} onChange={setStrokesPerMin} /> brush strokes per minute (thank you Mom and Dad for doing this for years!)
          </li>
          <li>
            <InlineStepper value={blinksPerDay} min={10000} max={25000} step={1000} onChange={setBlinksPerDay} /> blinks per day
          </li>
        </ul>
      </Body>
    </Slide>
