// V12: Short Circuit
// Same as V11 but with V5's simpler broken mode flickering instead of dying lightbulbs.
...
export function initV12(container: HTMLElement, name: string, dob: string) {
  let disposed = false;
