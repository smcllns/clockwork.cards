  ...
  return (
    <TileContainer id="5" title={`${name}'s brain & body`}>
      <Tile id="5b" emoji="❤️"
        ...
        unit="heartbeats"
        lede={`${heart.heartbeatsPerDay.toLocaleString()} beats per day`}
      ...
      <Tile id="5c" emoji="🥦"
        ...
        lede="Delivered by fruits & veggies"
      ...
      <Tile id="5e" emoji="💪"
        ...
        lede={`${name}'s lungs are getting seriously strong`}
