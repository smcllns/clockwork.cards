  ...
  return (
    <PhotoSlide id="5f" imgLight={imgLight} imgShiny={imgShiny} shiny={shiny} objectPosition="center 30%">
      ...
      <Body>
        ...
        <InlineStepper value={water.glassesPerDay} min={2} max={12} step={1} onChange={water.setGlassesPerDay} /> glasses a day, it would
        take {name} about {Math.floor(water.poolYearsRemaining).toLocaleString()} more years to drink the rest.
      </Body>
    </PhotoSlide>
  );
}
